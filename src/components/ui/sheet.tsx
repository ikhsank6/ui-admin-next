    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
            floating && [
              "inset-y-4 right-0 h-auto max-h-[calc(100vh-2rem)] w-3/4 rounded-l-xl border-l border-y sm:max-w-sm",
              "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
            ],
          side === "left" &&
            !floating && [
          ...
          side === "left" &&
            floating && [
              "inset-y-2 left-2 h-auto max-h-[calc(100vh-1rem)] w-3/4 rounded-xl border sm:max-w-sm",
              "data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left",
            ],
          side === "top" && [
